...
namespace vca
{
  ...
  namespace icf
  {
    ...
    class VCA_API FeaturePipeGradientsUsingLuv : public Featurepipe
    {
    public:
      ...
      */
      ...
      FeaturePipeGradientsUsingLuv(const FeaturepipeType& t)
      {
        quantDir_.cfg(t);
        height_ = width_ = 0;
        border_ = 0;
        ...
        sassert(featurepipeType_.dxdytype_ == FeaturepipeType::nonabsluv);
      ...
      void calcMap(const cv::Mat& src) override
      {
        ...
        maxPar_.calcMap(luv_.lMap, luv_.uMap, luv_.vMap);
