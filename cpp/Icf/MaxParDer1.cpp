...
namespace vca
{
  ...
  */
  ...
  void icf::MaxParDer1::calcMap(const cv::Mat& src)
  {
...
#pragma omp parallel for
  ...
  void icf::MaxParDer1::calcMap(const cv::Mat& src1, const cv::Mat& src2, const cv::Mat& src3)
  {
    //    FEATURES_TRACE( "Calc. feature map " << src.cols << " , " << src.rows << " / " << src.channels() );
